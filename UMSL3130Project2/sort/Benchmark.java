 ...
 * Purpose: The purpose of the programming assignment is to perform empirical comparative analysis of several modifications of Quicksort for integer arrays.
 */
...
import edu.umsl.cs.UMSL3130Project2.sort.QuickSortWithSwitching;
//This class is to benchmark the times it takes for each alogrithem to complete
public class Benchmark {
	//Hard coded values Used to generation of random numbers, the min and max being the range and Nth position for almost sorted
	...
	//actually created the array for random data
	...
	//actually created the array for sorted data
	...
	//actually created the array for almost sorted data
	...
	//function that acutally does the test
